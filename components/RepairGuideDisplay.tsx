...
import { AlertIcon, WrenchIcon, ListIcon, CheckCircleIcon } from './Icons';
...
const RepairGuideDisplay: React.FC<RepairGuideDisplayProps> = ({ guide, onReset }) => {
    ...
    const TabButton = ({ tab, label, icon }: { tab: Tab, label: string, icon: React.ReactNode }) => (
        <button
            ...
            className={`flex items-center gap-2 px-4 py-3 font-bold rounded-lg transition-all duration-200 uppercase text-sm tracking-wider ${
                activeTab === tab 
