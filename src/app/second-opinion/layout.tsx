...
export const metadata: Metadata = {
  title: 'Mechanic Quote Checker — Get a Free 2nd Opinion | AllOEMManuals',
  description:
  ...
  alternates: {
    canonical: 'https://alloemmanuals.com/second-opinion',
  },
  openGraph: {
    title: 'Mechanic Quote Checker — Get a Free 2nd Opinion | AllOEMManuals',
    description:
      'Is your mechanic overcharging you? Get an AI-powered 2nd opinion on any auto repair quote. Free instant analysis for your specific vehicle.',
    url: 'https://alloemmanuals.com/second-opinion',
    type: 'website',
