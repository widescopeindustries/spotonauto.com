      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 text-gray-300 space-y-8">
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-1 text-sm">
            <li><strong>OEM corpus data</strong> — factory service manual information for vehicles from 1982–2013. Pages backed by this data display an &quot;OEM Verified&quot; badge.</li>
            <li><strong>AI-generated content</strong> — for vehicles outside our OEM corpus coverage (2014 and newer), content is generated by artificial intelligence (Google Gemini) and clearly labeled as AI-generated.</li>
          </ul>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="text-sm">
            ...
            within our corpus coverage (1982–2013) display an &quot;OEM Verified&quot; badge when the underlying data
