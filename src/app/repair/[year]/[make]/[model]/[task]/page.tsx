...
const TASK_META: Record<string, { title: string; description: string; extraKeywords: string[] }> = {
    'serpentine-belt-replacement': {
        ...
        description: 'Free belt routing diagram and step-by-step replacement for your {v}. Belt size, tensioner check, and squeal diagnosis included. Save $100–$200 vs. the shop.',
        extraKeywords: ['serpentine belt diagram', 'belt routing diagram', 'belt replacement cost'],
    },
    'timing-belt-replacement': {
        title: 'Timing Belt Replacement Guide',
        description: 'Step-by-step timing belt replacement for your {v} with timing marks diagram, torque specs, and water pump tips. Interference engine warning included. Free guide.',
        extraKeywords: ['timing belt diagram', 'timing marks', 'timing belt cost'],
    },
    'battery-replacement': {
        title: 'Battery Replacement — Size & Cost',
        description: 'Exact battery group size, location, and step-by-step replacement for your {v}. 15-minute DIY job — save $50–$100 vs. the shop. Free guide with OEM specs.',
        extraKeywords: ['battery location', 'battery group size', 'battery replacement cost'],
    },
    'oil-change': {
        title: 'Correct Oil Type & Capacity',
        description: 'Exact oil weight, capacity, and filter part number for your {v}. Drain plug torque and change interval included. 30-min DIY — save $50–$120 vs. the shop.',
        extraKeywords: ['oil type', 'oil capacity', 'oil weight', 'oil change cost'],
    },
    'spark-plug-replacement': {
        title: 'Spark Plug Replacement Guide',
        description: 'Correct spark plug part number, gap, and torque spec for your {v}. Coil-on-plug diagram, change interval, and anti-seize tips included. Free step-by-step guide.',
    ...
    'headlight-bulb-replacement': {
        ...
        description: 'Correct headlight bulb size and step-by-step replacement for your {v}. Low beam, high beam, and DRL fitment. 10–30 min DIY — no special tools on most models.',
    ...
    'tail-light-replacement': {
        ...
        description: 'Step-by-step tail light replacement for your {v}. Bulb vs. full assembly check, correct bulb number, and access instructions. 10–20 min DIY, no special tools.',
    ...
    'alternator-replacement': {
        ...
        description: 'How to diagnose and replace the alternator on your {v}. Voltage test steps, failure symptoms, and realistic cost range. Free guide — save $150–$300 vs. shop.',
    ...
    'starter-replacement': {
        ...
        description: 'Click-no-crank? Diagnose and replace the starter on your {v}. Location, wiring checks, and step-by-step removal. Free guide — save $150–$400 vs. shop labor.',
    ...
    'brake-pad-replacement': {
        ...
        description: 'Step-by-step brake pad replacement for your {v}. Correct pad size, caliper torque specs, and bed-in procedure. 1-hour DIY — save $100–$250 per axle vs. shop.',
    ...
    'brake-rotor-replacement': {
        ...
        description: 'Correct rotor size and minimum thickness spec for your {v}. Step-by-step replacement with hub cleaning tips and torque specs. Always replace rotors in pairs.',
    ...
    'water-pump-replacement': {
        ...
        description: 'Water pump failure signs, exact location, and step-by-step replacement for your {v}. Gasket vs. O-ring, coolant type, and belt-driven vs. chain-driven notes.',
    ...
    'thermostat-replacement': {
        ...
        description: 'Exact thermostat location and step-by-step replacement for your {v}. Overheating diagnosis, coolant specs, and bleed sequence. Typical DIY cost: $30–$80.',
    ...
    'radiator-replacement': {
        ...
        description: 'Step-by-step radiator replacement for your {v}. Coolant drain, hose clamp tips, and trans cooler line notes. Save $200–$500 vs. shop labor. Free guide.',
    ...
    'cabin-air-filter-replacement': {
        ...
        description: 'Exact cabin air filter size and location for your {v}. Step-by-step replacement — 5-minute job, no tools needed. Filter direction and change interval included.',
    ...
    'engine-air-filter-replacement': {
        ...
        description: 'Correct engine air filter part number for your {v}. Step-by-step airbox replacement — 5-minute job, no tools needed. Change interval and fitment check included.',
    ...
    'ignition-coil-replacement': {
        ...
        description: 'How to test and replace a bad ignition coil on your {v}. Misfire code diagnosis, coil-on-plug vs. distributor check, and step-by-step replacement. Free guide.',
    ...
    'oxygen-sensor-replacement': {
        ...
        description: 'Upstream and downstream O2 sensor location for your {v}. Symptoms, thread size, and step-by-step replacement with anti-seize tips. Save $100–$200 vs. shop.',
    ...
    'catalytic-converter-replacement': {
        ...
        description: 'Got P0420? Catalytic converter diagnosis and replacement guide for your {v}. OEM vs. aftermarket comparison, upstream vs. downstream, and realistic cost ranges.',
    ...
    'transmission-fluid-change': {
        ...
        description: 'Correct transmission fluid type and capacity for your {v}. Step-by-step drain-and-fill with dipstick location and filter change tips. Free DIY guide.',
    ...
    'coolant-flush': {
        ...
        description: 'Correct coolant type and capacity for your {v}. Step-by-step flush with drain location, bleed sequence, and change interval. Free DIY guide.',
    ...
    'cv-axle-replacement': {
        ...
        description: 'Clicking when turning? CV axle diagnosis and step-by-step replacement for your {v}. Inner vs. outer joint, torque specs, and cost. Save $200–$400 vs. shop.',
    ...
    'shock-absorber-replacement': {
        ...
        description: 'Worn shocks? Diagnose bouncing, nose dive, and uneven tire wear on your {v}. Step-by-step replacement guide. Save $150–$400 vs. the shop.',
    ...
    'strut-replacement': {
        ...
        description: 'Front and rear strut replacement for your {v}. Failure symptoms, spring compressor safety, torque specs, and alignment notes. Save $200–$500 vs. shop labor.',
    ...
    'fuel-pump-replacement': {
        ...
        description: 'Fuel pump failure signs and step-by-step replacement for your {v}. In-tank vs. external type, pressure specs, and priming procedure. Free guide with OEM data.',
    ...
    'fuel-filter-replacement': {
        ...
        description: 'Exact fuel filter location and step-by-step replacement for your {v}. Flow direction, pressure-relief steps, and fitment check before you buy the part.',
