  ...
  return (
    <section className="mb-12 rounded-2xl border border-cyan-500/25 bg-cyan-950/20 p-6 md:p-8">
      ...
      <div className="mt-4 grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
        <div>
          <h2 className="text-2xl font-bold text-white">
            Know the exact {toolLabel.toLowerCase()} specs for your {vehicleName}
          </h2>
        ...
        <div className="rounded-xl border border-white/10 bg-black/20 p-5">
          ...
          <p className="mt-3 text-sm leading-6 text-gray-300">
            Use our specs compiler or view the maintenance hub to confirm details for your specific engine, trim, or model year. That keeps the buying list and repair steps aligned.
          </p>
      ...
      {citationGroups.length > 0 && (
        <div className="mt-8">
          <h3 className="text-sm font-bold uppercase tracking-[0.18em] text-cyan-300 mb-4">
              ...
              >
                <div>
                  ...
                  <p className="mt-1 text-xs uppercase tracking-[0.16em] text-gray-400">
                    Specs compiled for {group.yearsLabel}
                  </p>
                </div>
                  ...
                  {group.citations.map((citation) => (
                    <div key={citation.path} className="rounded-lg border border-cyan-500/15 bg-black/20 p-4">
                      ...
                      <p className="mt-2 text-sm leading-6 text-gray-400">
                        Official specification source analyzed for exact clearances, fluid types, and installation parameters.
                      </p>
                    </div>
                  ))}
                </div>
