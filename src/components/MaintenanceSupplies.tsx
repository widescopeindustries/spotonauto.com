...
const SUPPLIES_BY_TYPE: Record<string, SupplyItem[]> = {
    ...
    'serpentine-belt': [
        { name: 'Serpentine Belt', description: 'High-quality EPDM belt for quiet, reliable operation.', icon: '⚙️', searchQuery: 'serpentine belt' },
        { name: 'Belt Tensioner Tool', description: 'Slim-profile tool for tight engine bays.', icon: '🛠️', searchQuery: 'serpentine belt tool' },
        { name: 'Pulley Puller', description: 'Required if you need to replace idler or tensioner pulleys.', icon: '🔩', searchQuery: 'pulley puller set' },
    ],
    'coolant-type': [
