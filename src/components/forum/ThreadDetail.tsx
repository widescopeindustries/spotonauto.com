...
export default function ThreadDetail({ thread, posts }: ThreadDetailProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="glass p-6 rounded-xl text-center text-gray-400">
        Reading is open to everyone. Reply posting requires a signed-in account and moderator review.
      </div>
    </div>
  );
}
