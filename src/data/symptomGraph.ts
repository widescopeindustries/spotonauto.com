...
export const SYMPTOM_CLUSTERS: SymptomCluster[] = [
  {
    ...
    likelyTasks: keepValidTasks(['brake-rotor-replacement', 'brake-pad-replacement', 'wheel-bearing-replacement', 'tie-rod-replacement']),
  ...
  },
  {
    ...
    likelyTasks: keepValidTasks(['battery-replacement', 'starter-replacement', 'alternator-replacement', 'crankshaft-sensor-replacement', 'fuel-pump-replacement']),
  ...
  },
  {
    ...
    likelyTasks: keepValidTasks(['thermostat-replacement', 'radiator-replacement', 'water-pump-replacement', 'coolant-flush', 'head-gasket-replacement']),
  ...
  },
  {
    ...
    likelyTasks: keepValidTasks(['alternator-replacement', 'battery-replacement', 'serpentine-belt-replacement', 'drive-belt-replacement']),
  ...
  },
  {
    ...
    likelyTasks: keepValidTasks(['spark-plug-replacement', 'ignition-coil-replacement', 'mass-air-flow-sensor-replacement', 'oxygen-sensor-replacement', 'timing-chain-replacement']),
  ...
  },
  {
    ...
    likelyTasks: keepValidTasks(['tie-rod-replacement', 'ball-joint-replacement', 'wheel-bearing-replacement', 'brake-pad-replacement']),
  ...
  },
  {
    ...
    likelyTasks: keepValidTasks(['brake-pad-replacement', 'brake-rotor-replacement', 'brake-fluid-flush']),
    systems: ['Brakes'],
  },
  {
    ...
    likelyTasks: keepValidTasks(['transmission-fluid-change', 'clutch-replacement']),
  ...
  },
  {
    ...
    likelyTasks: keepValidTasks(['oxygen-sensor-replacement', 'mass-air-flow-sensor-replacement', 'ignition-coil-replacement', 'spark-plug-replacement', 'catalytic-converter-replacement']),
  ...
  },
  {
    ...
    likelyTasks: keepValidTasks(['serpentine-belt-replacement']),
