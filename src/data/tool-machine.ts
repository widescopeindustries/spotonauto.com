...
const TEMPLATES: Record<string, ToolTypeTemplate> = {
  ...
  'tire-size': {
    ...
    descTemplate: 'Find OEM tire sizes, wheel specs, and recommended tire pressure for the {make} {model} by year and trim level. Factory-fit data from the service manual to help you buy the right tires.',
  ...
  'serpentine-belt': {
    ...
    descTemplate: 'Find serpentine belt routing diagrams, belt size, tensioner location, and step-by-step replacement info for the {make} {model}. Factory service manual data for all model years.',
  ...
  'headlight-bulb': {
    ...
    descTemplate: 'Find low beam, high beam, and fog light bulb sizes for the {make} {model} by year and trim. OEM fitment data from the factory service manual with replacement tips and warnings.',
  ...
  'fluid-capacity': {
    ...
    descTemplate: 'Find all fluid capacities for the {make} {model} — engine oil, coolant, transmission, brake, differential, power steering, and more. Factory service manual specs by year and engine for accurate refills and flushes.',
  ...
  'spark-plug-type': {
    ...
    descTemplate: 'Find the correct spark plug type, gap setting, torque spec, and replacement interval for the {make} {model}. Factory service manual data for iridium, platinum, and copper plugs by year.',
  ...
  'wiper-blade-size': {
    ...
    descTemplate: 'Find wiper blade sizes for the {make} {model} — driver side, passenger side, and rear wiper. OEM length specs by year and trim from the factory service manual with replacement tips.',
